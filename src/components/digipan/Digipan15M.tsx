...
const Digipan15M = React.forwardRef<Digipan3DHandle, Digipan15MProps>(({
    ...
    const internalNotes = useMemo(() => {
        ...
        // Add Manual Snare Buttons (Bottom Left/Right) - Same as E Equinox 14
    ...
    // Filter notes for the Permanent Visual Layer (Bottom 4 notes: IDs >= 12, exclude snares)
    const visualNotes = useMemo(() => {
        return notesToRender.filter(n => n.id >= 12 && n.id < 98);
    }, [notesToRender]);
